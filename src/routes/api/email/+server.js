...
export async function POST({ request }) {
	...
	const body = `<!DOCTYPE html>
                    ...
                    <title>New Contact Message - Lucienne Community School</title>
                    </head>
                    <body style="margin:0;padding:0;background-color:#2a6be1;font-family:Arial, Helvetica, sans-serif;font-size:18px;">

                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#2a6be1;padding:24px 0;">
                        <tr>
                        <td align="center">
                            ...
                            <tr>
                                ...
                                <p style="margin:4px 0 0;font-size:14px;">Lucienne Community School</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <table width="100%" cellpadding="8" cellspacing="0" border="0" style="border-collapse:collapse;border:1px solid #e5e7eb;border-radius:6px;">
                                    ...
                                    <td style="border-bottom:1px solid #e5e7eb;">${number}</td>
                                    </tr>
                                    <tr>
                            ...
                            <tr>
                                ...
                                <p style="font-size:12px;color:#6b7280;margin:0;">
                                    © 2025 Lucienne Community School. All rights reserved.
                                </p>
                                </td>
                            </tr>
                            </table>
...
`;
	try {
		...
		const mailOptions = {
			...
			subject: 'Lucienne Community School',
			text: message,
			html: body,
			inline_css: true,
			tags: [
